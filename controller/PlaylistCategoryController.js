...
const model = require('../models/PlaylistCategory')
        ...
        switch(method) {
            case 'store': {
                return [
                    ...
                    check('title', 'The fields title is required').exists(),
                    check('description', 'The fields description is required').exists(),
                    check('status', 'The fields status is required').exists(),
                ]
            }
        }
    },
